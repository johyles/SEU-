<template>
    <div class="login_container">
      <div id="背景"></div>
        <div class ="login_box">
            <div style="margin-bottom:20px"><img src="../assets/img/dongnan.png" width="50%"></div>
...
export default {
  ...
  methods: {
    ...
    login () {
      ...
      axios.post('http://127.0.0.1:8080/api/user/login', formData
      ).then(res => {
          if (res.data.code===200){
            ...
            axios.post('http://127.0.0.1:8080/api/user/information').then(res => {
...
#背景{
   position: fixed;
      ...
      z-index: -10;
      object-fit: cover;
      background-image: url('../assets/img/微信2.jpg');
}
</style>
