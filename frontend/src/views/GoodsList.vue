                ...
                <div class="商品类别">
                    <div class="标题">
                        ...
                        <el-checkbox-group v-model="checklist" class="checkbox">
                            ...
                            <p><el-checkbox label="衣帽鞋服"></el-checkbox></p>
                            <p><el-checkbox label="日用品"></el-checkbox></p>
                            <p><el-checkbox label="书籍"></el-checkbox></p>
                            <p><el-checkbox label="食品"></el-checkbox></p>
                        </el-checkbox-group>
                    </div>
                </div>
                <div class="筛选搜索">
            ...
            <div class="右侧商品栏">
                ...
                <el-card shadow="hover" class="商品格" v-for="(value,index) in 商品列表" :key="index" v-loading="cardloading">
                    <div class="商品图片格" @click="toshop(value.id)">
                        <img :src="value.pictureUrl" width="90%">
                    </div>
                    <div class="销量和价格">
                        <div class="商品价格">¥{{value.price.toFixed(2)}}</div>
