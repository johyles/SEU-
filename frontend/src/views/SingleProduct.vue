        ...
        <div id="商品详情">
            <div id="商品详情容器">
                ...
                <div id="商品详情栏" class="商品详情栏">
                        ...
                        <div class="疫情相关">
                            【本产品已通过核酸检测】SEU，保证您的商品安全，为您的健康保驾护航。
                        </div>
                    <div id="商品其他信息">
                        <el-card shadow="never">
                            <div class="内容标题">
                                <div id="商品价格"><p>SEU闲置优价: ￥{{price}}</p></div>
                                <div>商品状态 ：【在售】</div>
        ...
        <div id="其他信息容器">
         <div id="其他信息">
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    <el-tab-pane label="商品描述" name="first"><p>{{this.details}}</p></el-tab-pane>
...
export default {
  ...
  created () {
    ...
    axios.post('http://127.0.0.1:8080/api/product/getone', {
      id: this.id
    }).then(res => {
      ...
      axios.post('http://127.0.0.1:8080/api/product', {
        pageNum: 6,
    ...
    axios.post('http://127.0.0.1:8080/api/product/comment', {
      productId: this.id
    }).then(res => {
    ...
    submitclick () {
      if (this.nowuser.name === '') {
        ...
        if (this.nowuser.comment === '' || this.nowuser.star === '') {
          ...
          axios.defaults.headers.common.Authorization = JSON.parse(localStorage.currentuser).token
          axios.post('http://127.0.0.1:8080/api/user/makecomment', {
